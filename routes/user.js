...
router.get('/booking-full',userController.bookingFull)
router.get('/resume-booking',userController.resumeBooking)
...
router.post('/book-pay-on-clinic',userController.bookPayOnClinic)
router.post('/select-payment',userController.selectPayment)
