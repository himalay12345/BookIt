...
router.get('/active-device', homeController.activeDevice);
...
router.get('/delete-account', homeController.deleteAccount);
...
router.get('/notification-settings', homeController.notificationSettings);
