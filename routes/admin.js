...
router.get('/account-change', adminController.accountChange);
router.post('/approve-documents', adminController.approveDocuments);
router.post('/approve-bank', adminController.approveBank);
router.post('/approve-requested-bank',adminController.approveRequestedBank);
...
router.get('/change-profile', adminController.changeProfile);
